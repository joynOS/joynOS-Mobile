            ...
            <View style={styles.header}>
                        ...
                        {filterTabs.map(tab => (
                            ...
                            >
                                <Text style={[
                                    ...
                                    activeFilter === tab.id ? styles.filterPillTextActive : null,
                                ]}>
                                    {tab.label}
                                </Text>
                            </TouchableOpacity>
                ...
                <View style={styles.headerRight}>
                    ...
                    <Button
                        ...
                        style={[ styles.iconButton, currentIntent ? { backgroundColor: 'rgba(0, 196, 140, 0.125)' } : null,]}
                        title=""
                    >
            ...
            <View style={styles.content}>
                {activeFilter === 'feed' ? (
                    ...
                    <View style={styles.discoveryContainer}>
                        ...
                        <ScrollView
                            contentContainerStyle={[styles.gridContainer, { paddingTop: 160, paddingBottom: 16 }]}
                            showsVerticalScrollIndicator={false}
                        ...
                        >
                            {events && events.length > 0 ? (
                                        ...
                                        {events.map((event, index) => {
                                            const vibeScore = Math.min(
                                                ...
                                                Math.max(
                                                    75,
                                                    Math.floor(
                                                        80 + (event.id * 7) % 20 + (event.tags?.length || 0) * 2 + (event.category === 'Nightlife' ? 5 : 0)
                                                    )
                                                )
                                            );
                                            ...
                                            return (
                                                ...
                                                >
                                                    <Image
                                                        source={{ uri: event.imageUrl || `https://images.unsplash.com/photo-${1492684223066 + index}?w=400&h=600&fit=crop&crop=center` }}
                                                    ...
                                                    <View style={styles.gridItemInfo}>
                                                        <View style={styles.gridItemTop}>
                                                            ...
                                                            <View style={styles.vibeScoreContainer}>
                                                                ...
                                                                <Text style={[styles.vibeScoreText, { color: scoreColor }]}>
                                                                    {vibeScore}%
                                                                </Text>
                                                            </View>
                                                        </View>
                                ...
                                <View style={styles.discoveryEmpty}>
                                    ...
                                    <Text style={styles.discoveryEmptyTitle}>No events to discover</Text>
                                    <Text style={styles.discoveryEmptySubtitle}>
                                        Check back later for new events to explore, or try creating your own event
                                    </Text>
                                    <Button
